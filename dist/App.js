...
function App() {
    ...
    return ((0, jsx_runtime_1.jsxs)(package_1.Background, __assign({ as: "section", fill: "#f2f3fa", flex: 1, h: "100vh" }, { children: [(0, jsx_runtime_1.jsxs)(package_1.Padding, __assign({ all: 40, ref: ttRef }, { children: [(0, jsx_runtime_1.jsx)(TouchableOpacity_1.default, { children: "\uBC84\uD2BC\uC774\uC57C" }), (0, jsx_runtime_1.jsxs)(package_1.Flex, __assign({ h: "100%", as: "ul", ref: ttRef, direc: "row", gap: 25, _mq: {
                            w600: { direc: "column" },
