...
var Flex = react_2.default.forwardRef(function (props, ref) {
    ...
    var combinedStyles = (0, react_2.useMemo)(function () {
        var _a, _b, _c;
        return (0, react_1.css)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        ", "\n        ", "\n    ", "\n    ", "\n    ", "\n      "], ["\n        ", "\n        ", "\n    ", "\n    ", "\n    ", "\n      "])), baseStyle, ExtendedStyles(__assign(__assign({}, pPs), { sizes: __assign(__assign({}, pPs.sizes), { width: (_b = (_a = pPs.sizes) === null || _a === void 0 ? void 0 : _a.width) !== null && _b !== void 0 ? _b : "100%" }), direction: (_c = pPs.direction) !== null && _c !== void 0 ? _c : "column" })), mediaStyles, pseudoStyles, cssProp);
