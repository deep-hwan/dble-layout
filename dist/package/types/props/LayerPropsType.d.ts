...
export interface LayerType extends Omit<HTMLAttributes<HTMLElement>, ExcludedProps> {
    w?: number | string;
    maxW?: number | string;
    minW?: number | string;
    h?: number | string;
...
interface LayerPropsType<T extends ElementType> extends Omit<LayerType, ExcludedProps> {
    as?: T;
...
export type LayerLayoutElement = Omit<LayerPropsType<LayoutElementType>, ExcludedProps>;
export {};
