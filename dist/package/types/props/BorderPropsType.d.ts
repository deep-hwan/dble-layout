...
export interface BorderType extends Omit<HTMLAttributes<HTMLElement>, ExcludedProps> {
    w?: number | string;
    maxW?: number | string;
    minW?: number | string;
    h?: number | string;
...
interface BorderPropsType<T extends ElementType> extends Omit<BorderType, ExcludedProps> {
    as?: T;
...
export type BorderLayoutElement = Omit<BorderPropsType<LayoutElementType>, ExcludedProps>;
export {};
