...
export interface TextType extends Omit<HTMLAttributes<HTMLParagraphElement>, "size" | "sizes" | "color" | "title" | "hidden"> {
    w?: number | string;
    maxW?: number | string;
    minW?: number | string;
    h?: number | string;
...
export type TextElementType = "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "strong" | "b" | "i" | "p" | "span" | "div" | "li" | "label";
export type TextLayoutElement = Omit<TextPropsType<TextElementType>, ExcludedProps>;
export type TextPropsRef = Omit<ComponentPropsWithoutRef<TextElementType>, ExcludedProps>;
type ExcludedProps = "sizes" | "title" | "hidden" | "title" | "translate" | "radioGroup";
export {};
