...
export interface BackgroundType extends Omit<HTMLAttributes<HTMLElement>, ExcludedProps> {
    w?: number | string;
    maxW?: number | string;
    minW?: number | string;
    h?: number | string;
...
interface BackgroundPropsType<T extends ElementType> extends Omit<BackgroundType, ExcludedProps> {
    as?: T;
